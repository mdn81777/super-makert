...
public class ServiceFactory {
    ...
    public  static SupplierService getSupplierServiceInstance(){ return  new SupplierServiceImpl(); }
    public  static ReceiptService getReceiptServiceInstancw() { return  new ReceiptServiceImpl(); }
    public  static  PositionService getPositionServiceInstance() {return  new PositionServiceImpl();}
